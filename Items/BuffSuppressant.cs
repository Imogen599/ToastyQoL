    ...
    public class BuffSuppressant : ModItem
    {
        ...
        public override void UpdateInventory(Player player)
        {
            if (Item.favorited)
            {
                ...
                {
                    player.buffImmune[ModContent.BuffType<TriumphBuff>()] = true;
                }
                ...
                if (!NPC.downedBoss3) //Skeletron
                {
                    ...
                    player.buffImmune[ModContent.BuffType<YharimPower>()] = true;
                    player.buffImmune[BuffID.Bewitched] = true;
                    //player.buffImmune[ModContent.BuffType<OceanSpiritBuff>()] = true;
                }
                if (!Main.hardMode)
                {
                    player.buffImmune[ModContent.BuffType<ArmorCrumbling>()] = true;
                ...
                {
                    player.buffImmune[ModContent.BuffType<AbyssalWeapon>()] = true;
                    player.buffImmune[ModContent.BuffType<PenumbraBuff>()] = true;
                }
                ...
                if (!NPC.downedGolemBoss)
                {
                    ...
                    player.buffImmune[ModContent.BuffType<TitanScale>()] = true;
                    //Booze
                ...
                {
                    player.buffImmune[ModContent.BuffType<HolyWrathBuff>()] = true;
                    player.buffImmune[ModContent.BuffType<ProfanedRageBuff>()] = true;
                ...
                {
                    player.buffImmune[ModContent.BuffType<DraconicSurgeBuff>()] = true;
                }
