...
namespace CalNohitQoL.Items.BossSpawners.PostMoonlord
{
    public class YharonSpawner : ModItem
    {
        ...
        {
            Color color = CalNohitQoLUtils.TwoColorPulse(new Color(255, 165, 0), new Color(255, 140, 0), 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.SummonItems.JungleDragonEgg>(), 1);
