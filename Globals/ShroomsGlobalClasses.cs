...
namespace CalNohitQoL.Globals
{
    public class ShroomsPlayer : ModPlayer
    {
        ...
        public override void PreUpdate()
        {
            ...
            else if (Toggles.ShroomsExtraDamage && Trippy)
            {
                Player.GetDamage<GenericDamageClass>() += 0.5f;
            }
    ...
    public class ShroomsGlobalProjectile : GlobalProjectile
    {
        ...
        // Isnt related to shrooms but I dont want to make another class for only these.
    ...
    public class ShroomsGlobalNPC : GlobalNPC
    {
        ...
        public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            else if (Main.LocalPlayer.GetModPlayer<ShroomsPlayer>().Trippy)
            {
                SpriteEffects effects = SpriteEffects.None;
                if (npc.spriteDirection == 1)
                {
