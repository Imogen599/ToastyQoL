    ...
    public class CalNohitQoLLists
    {
        ...
        public static void LoadLists()
        {
            ...
            PostWallOfFlesh = new List<int>
            {
                ...
                ModContent.ItemType<ThiefsDime>(),
            ...
            PostAllMechs = new List<int>
            {
                ...
                //Classless
                ModContent.ItemType<LightningHawk>(),
                //Vanilla
                3353,
                1225,
                935,
            ...
            PostPlaguebringerGoliath = new List<int>
            {
                ...
                //Weapons
                ModContent.ItemType<TrueForbiddenOathblade>(),
            ...
            PostMoonlord = new List<int>
            {
                ...
                //Classless
                ModContent.ItemType<ElephantKiller>(),
                //Vanilla
                1131,
                3577,
                4954,
            ...
            Endgame = new List<int>
            {
                ...
                ModContent.ItemType<CalamityMod.Items.Weapons.Ranged.Voidragon>(),//gets confused with the projectile else lo
                //Magic Weapons
