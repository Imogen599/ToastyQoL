...
namespace CalNohitQoL.UI
{
    public class SummonSlotUIIcon
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            Texture2D Icon = (Texture2D)ModContent.Request<Texture2D>("CalNohitQoL/UI/summonUI", (AssetRequestMode)2).Value;
            Texture2D HoverIcon = (Texture2D)ModContent.Request<Texture2D>("CalNohitQoL/UI/summonUIHover", (AssetRequestMode)2).Value;
            ...
            Vector2 IconCenter = new Vector2((float)Main.screenWidth - 400f, 10f) + Utils.Size(Icon) * 0.5f;
            // Rectangle area of the icon to check for hovering.
            Rectangle iconRectangeArea = Utils.CenteredRectangle(IconCenter, Utils.Size(Icon) * Main.UIScale);
