...
namespace CalNohitQoL.UI.QoLUI
{
    public class UpgradesUIManager
    {
        ...
        public void DrawElements(SpriteBatch spriteBatch)
        {
            ...
            Texture2D lockTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/lock", (AssetRequestMode)2).Value;
            Texture2D lockGlowTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/lockGlow", (AssetRequestMode)2).Value;
            Player player = Main.LocalPlayer;
            // Go down in intervals of around 120
            #region Toggle All

            Texture2D autoTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Auto", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                {
                    Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/AutoGlow", (AssetRequestMode)2).Value;
            ...
            Texture2D hpTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/BloodOrange", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                Rectangle hoverArea = Utils.CenteredRectangle(drawPos2, Utils.Size(hpTexture));

                if (mouseHitbox.Intersects(hoverArea))
                {
                    Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/BloodOrangeGlow", (AssetRequestMode)2).Value;
                    spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
            ...
            Texture2D manaTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/CometShard", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                Rectangle hoverArea = Utils.CenteredRectangle(drawPos2, Utils.Size(manaTexture));
                if (mouseHitbox.Intersects(hoverArea))
                {
                    Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/CometShardGlow", (AssetRequestMode)2).Value;
                    spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
            ...
            Texture2D rageTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/MushroomPlasmaRoot", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                Rectangle hoverArea = Utils.CenteredRectangle(drawPos2, Utils.Size(rageTexture));
                if (mouseHitbox.Intersects(hoverArea))
                {
                    Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/MushroomPlasmaRootGlow", (AssetRequestMode)2).Value;
                    spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
            ...
            Texture2D adrenUpgrade = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/ElectrolyteGelPack", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                Rectangle hoverArea = Utils.CenteredRectangle(drawPos2, Utils.Size(adrenUpgrade));
                if (mouseHitbox.Intersects(hoverArea))
                {
                    Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/ElectrolyteGelPackGlow", (AssetRequestMode)2).Value;
                    spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
            ...
            Texture2D accTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/DemonHeart", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                Rectangle hoverArea = Utils.CenteredRectangle(drawPos2, Utils.Size(accTexture) * 0.85f);
                if (mouseHitbox.Intersects(hoverArea))
                {
                    Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/DemonHeartGlow", (AssetRequestMode)2).Value;
                    spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            Rectangle hoverArea = Utils.CenteredRectangle(spawnPos, Utils.Size(backgroundTexture));
            Rectangle mouseHitbox = new Rectangle(Main.mouseX, Main.mouseY, 2, 2);
