    ...
    public class TogglesUIManager
    {
        ...
        public virtual List<TogglesUIElement> UIElementList
        {
            get
            {
                ...
                list.Add(new TogglesUIElement("Set Spawn", ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/setSpawnUIIcon", (AssetRequestMode)2).Value, delegate
                {
                ...
                list.Add(new TogglesUIElement("Progression Locks", ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/locksUIIcon", (AssetRequestMode)2).Value, delegate
                {
                ...
                list.Add(new TogglesUIElement("Misc Toggles", ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/settingsUIIcon", (AssetRequestMode)2).Value, delegate
                {
                ...
                list.Add(new TogglesUIElement("Set Powers", ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/playerUIIcon", (AssetRequestMode)2).Value, delegate
                {
                ...
                list.Add(new TogglesUIElement("World Toggles", ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/worldUIIcon", (AssetRequestMode)2).Value, delegate
                {
                ...
                list.Add(new TogglesUIElement("Boss Toggles", ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/bossDeathsUIIcon", (AssetRequestMode)2).Value, delegate
                {
        ...
        public void DrawElements(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < UIElementList.Count; i++)
            {
                ...
                Texture2D bloomTexture = ModContent.Request<Texture2D>("CalNohitQoL/ExtraTextures/Bloom", (AssetRequestMode)2).Value;
                float rot = Main.GlobalTimeWrappedHourly * 0.5f;
                spriteBatch.Draw(bloomTexture, spawnPos, null, new Color(59, 50, 77) * (0.9f*opacity), rot, new Vector2(123f, 124f), 0.4f, (SpriteEffects)0, 0f);
                spriteBatch.End();
                ...
                Texture2D animationTex = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/animatedGlow", (AssetRequestMode)2).Value;
                if (animationActive&& currentHover == i)
                {
                    ...
                    spriteBatch.Draw(animationTex, spawnPos+sizeDiffOffset, (Rectangle?)animCropRect, Color.White*0.55f,0, Utils.Size(animationTex) * 0.5f, 1, 0, 0f);
                }           
            }
        }
        ...
        public static void DrawElementWithBasicToggle(SpriteBatch spriteBatch,Texture2D baseTexture, Texture2D glowTexture, Player player, int index,float baseVerticalOffset,float baseOffsetAmount,string displayText, string hoverTextFormatted, ref bool thingToToggle, SpecialToggleOnClick extraOnClickEffect = SpecialToggleOnClick.None)
        {
            ...
            fancyTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/whiteTangle", (AssetRequestMode)2).Value;
            if (index == 0)
            {
                baseOffsetAmount = 0;
            }
            ...
            if (isHovering)
            {
                ...
                Rectangle hoverArea = Utils.CenteredRectangle(drawPos2, Utils.Size(baseTexture));
            ...
            Texture2D statusTexture = thingToToggle ? ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/Tick", (AssetRequestMode)2).Value : ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/Cross", (AssetRequestMode)2).Value;
            Texture2D statusTextureGlow = thingToToggle ? ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/TickGlow", (AssetRequestMode)2).Value : ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/CrossGlow", (AssetRequestMode)2).Value;
