...
namespace CalNohitQoL.UI.QoLUI
{
    public class PowersUIManager
    {
        ...
        public void DrawElements(SpriteBatch spriteBatch)
        {
            ...
            fancyTextureSmall = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/SmallerWhiteRect", (AssetRequestMode)2).Value;
            Player player;
            ...
            switch (pageNumber)
            {
                case 1:
                    ...
                    if (isHovering)
                    {
                        ...
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/GodmodeGlow", (AssetRequestMode)2).Value;
                    ...
                    if (isHovering)
                    {
                        ...
                        if (mouseHitbox.Intersects(hoverArea))
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/InstantDeathGlow", (AssetRequestMode)2).Value;
                            spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
                    ...
                    if (isHovering)
                    {
                        ...
                        if (mouseHitbox.Intersects(hoverArea))
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/WingsGlow", (AssetRequestMode)2).Value;
                            spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
                    ...
                    if (isHovering)
                    {
                        ...
                        if (mouseHitbox.Intersects(hoverArea))
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/ManaGlow", (AssetRequestMode)2).Value;
                            spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
                    ...
                    if (isHovering)
                    {
                        ...
                        if (mouseHitbox.Intersects(hoverArea))
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/PotionGlow", (AssetRequestMode)2).Value;
                            spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
                ...
                case 2:
                    ...
                    if (isHovering)
                    {
                        ...
                        if (mouseHitbox.Intersects(hoverArea))
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/AmmoGlow", (AssetRequestMode)2).Value;
                            spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
                    ...
                    if (isHovering)
                    {
                        ...
                        if (mouseHitbox.Intersects(hoverArea))
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/UI/QoLUI/Textures/Powers/ConsGlow", (AssetRequestMode)2).Value;
                            spriteBatch.Draw(hoverTexture, drawPos2, null, Color.White, 0, hoverTexture.Size() * 0.5f, 1, 0, 0);
