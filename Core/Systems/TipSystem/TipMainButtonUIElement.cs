...
namespace CalNohitQoL.Core.Systems.TipSystem
{
    public class TipMainButtonUIElement
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            Vector2 iconCenter = new Vector2(Main.screenWidth - 330f, 155f);
            ...
            if (isHovering)
            {
                ...
                spriteBatch.Draw(bloomTex, iconCenter, null, Color.Cyan * opacity, rot, new Vector2(123f, 124f), scale2, 0, 0f);
                spriteBatch.End();
