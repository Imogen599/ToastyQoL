    ...
    public class CalNohitQoLGlobalItem : GlobalItem
    {
        ...
        public override void ModifyTooltips(Item itemID, List<TooltipLine> tooltips)
        {
            ...
            if (Toggles.PotionTooltips)
            {
                ...
                if (!Main.hardMode)
                {
                    ...
                    {
                        string text = "This is post Wall Of Flesh, you should not be using it.";
                        TooltipLine tooltip = new(Mod, "CalamityMod: SoaringPotion", text) { OverrideColor = Color.Red };
                        tooltips.Add(tooltip);
                    }
                    if (itemID.type == ModContent.ItemType<FlaskOfCrumbling>())
                    {
                        string text = "This is post Wall Of Flesh, you should not be using it.";
                ...
                if (Toggles.ItemTooltips)
                {
                    ...
                    if (!DownedBossSystem.downedCryogen)
                    {
                        ...
                        if (itemID.type == ModContent.ItemType<HoarfrostBow>())//if prime is dead but neither of the other two are, so no hallowed bars.
                        {
        ...
        public override bool CanUseItem(Item item, Player player)
        {
...

            {
                ...
                if (item.type == ModContent.ItemType<PotionofOmniscience>())
                {
                ...
                if (item.type == ModContent.ItemType<SupremeHealingPotion>())
                {
