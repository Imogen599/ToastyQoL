    ...
    public class BossTogglesUIManager
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (!ShouldDraw)
                return;
            // Draw the background.
            Texture2D backgroundTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/baseSettingsUIBackgroundWide", (AssetRequestMode)2).Value;
            Vector2 drawCenter;
        ...
        public void DrawElements(SpriteBatch spriteBatch, Vector2 spawnPos)
        {
            ...
            // ALL THE TEXTURES
            Texture2D crossTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/Cross", (AssetRequestMode)2).Value;
            Texture2D crossGlowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/CrossGlow", (AssetRequestMode)2).Value;
            Texture2D tickTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/Tick", (AssetRequestMode)2).Value;
            Texture2D tickGlowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/TickGlow", (AssetRequestMode)2).Value;
            Texture2D whiteGlowSmall = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/SmallerWhiteRect", (AssetRequestMode)2).Value;
            ...
            Texture2D deleteIconTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/thingForScrolling", (AssetRequestMode)2).Value;
            ...
            Texture2D scrollbarBackgroundTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/scrollbarBackground", (AssetRequestMode)2).Value;
            Texture2D scrollbarTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/fullScrollbar", (AssetRequestMode)2).Value;
            ...
            if (mouseHitbox.Intersects(backRect))
            {
                ...
                if (PlayerInput.MouseInfo.ScrollWheelValue - PlayerInput.MouseInfoOld.ScrollWheelValue > 0)
                {
                    ...
                    BossIconY += 50;
                    BossIconY = MathHelper.Clamp(BossIconY, -500f, 0f);
                    // This need it minused not added, I have no fucking idea why lmao.
                    ScrollbarOffset.Y -= 50 * 0.47f;
                    ScrollbarOffset.Y = MathHelper.Clamp(ScrollbarOffset.Y, 8f, 235f);
                }
            ...
            if (mouseHitbox.Intersects(scrollBarRect) || dragging)
            {
                ...
                if (Main.mouseLeft)
                {
                    ...
                    scrollbarTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/fullScrollbarClicking", (AssetRequestMode)2).Value;
                }
                ...
                else
                {
                    ...
                    if (mouseBasePos != default)
                    {
                        ...
                        BossIconY = MathHelper.Clamp(BossIconY, -500, 0);
                        dragging = false;
                        ScrollbarOffset.Y -= 4.5f * (mouseDistance.Y * 0.455f);
                        ScrollbarOffset.Y = MathHelper.Clamp(ScrollbarOffset.Y, 8, 235);
                    }
                }
            }
            else
        ...
        public void DrawBossIcons(SpriteBatch spriteBatch, Vector2 spawnPos, Vector2 killIfAbove, Vector2 killIfBelow)
        {
            ...
            Texture2D deleteIconTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/thingForScrolling", (AssetRequestMode)2).Value;
            Texture2D baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/kingSlime", (AssetRequestMode)2).Value;
            Texture2D glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/kingSlimeGlow", (AssetRequestMode)2).Value;
            Texture2D crossTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/Cross", (AssetRequestMode)2).Value;
            Texture2D crossGlowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/CrossGlow", (AssetRequestMode)2).Value;
            Texture2D tickTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/Tick", (AssetRequestMode)2).Value;
            Texture2D tickGlowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/TickGlow", (AssetRequestMode)2).Value;
            ...
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/desertScourge", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/desertScourgeGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/eoc", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/eocGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/crabulon", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/crabulonGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/eow", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/eowGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/boc", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/bocGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/hiveMind", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/hiveMindGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/perforators", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/perforatorsGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/queenBee", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/queenBeeGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/deerclops", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/deerclopsGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/skeletron", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/skeletronGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/slimeGod", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/slimeGodGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/wof", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/wofGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/empress", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/empressGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PreHardmodeXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/cultist", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/cultistGlow", (AssetRequestMode)2).Value;
            ...
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/queenSlime", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/queenSlimeGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/cryogen", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/cryogenGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/twins", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/twinsGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/brimmy", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/brimmyGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/destroyer", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/destroyerGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/aquaticScourge", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/aquaticScourgeGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/prime", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/primeGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/clone", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/cloneGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/plantera", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/planteraGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/levi", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/leviGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/aureus", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/aureusGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/golem", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/golemGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/pbg", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/pbgGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/fishron", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/fishronGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/deus", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/deusGlow", (AssetRequestMode)2).Value;
            ...
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/guardians", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/guardiansGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/folly", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/follyGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/provi", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/proviGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/void", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/voidGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/weaver", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/weaverGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/signus", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/signusGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/polter", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/polterGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/oldDuke", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/oldDukeGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/dog", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/dogGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/yharon", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/yharonGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/chin", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/chinGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/scal", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/scalGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/aew", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/aewGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/ravager", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/ravagerGlow", (AssetRequestMode)2).Value;
            ...
            iconSpawnPos += new Vector2(0, 50);
            finalDrawPos = iconSpawnPos + PostMoonlordXOffset + scrollOffset;
            baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/moonlord", (AssetRequestMode)2).Value;
            glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/moonlordGlow", (AssetRequestMode)2).Value;
            ...
            void ActuallyDrawBossIcons(float killHere, bool bossDeathValue, Boss boss, bool shrinkIcon = false)
            {
                ...
                if (killHere! > killIfAbove.Y && killHere! < killIfBelow.Y)
                {
                    ...
                    Texture2D whiteTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/BossIcons/bossWhiteRect", (AssetRequestMode)2).Value;
        ...
        public static void MarkAllBossesAsX(bool value)
        {
            ...
            DownedBossSystem.downedCalamitasClone = value;
