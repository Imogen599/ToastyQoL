...
namespace CalNohitQoL.Content.UI.UIManagers
{
    public class MiscUIManager
    {
        ...
        public static void DrawPage(int pageNumber, SpriteBatch spriteBatch)
        {
            ...
            switch (pageNumber)
            {
                case 1:
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        {
                            case 0: // Gravestones
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/gravestone", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/gravestoneGlow", (AssetRequestMode)2).Value;
                            ...
                            case 2: // Shrooms Extra Damage
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/shroom", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/shroomGlow", (AssetRequestMode)2).Value;
                                ...
                                TogglesUIManager.DrawElementWithBasicToggle(spriteBatch, baseTexture, glowTexture, player, i, baseVerticalOffset, baseVerticalInterval, textToSend, textToSendFormat, ref thingToSend, toggleOnClickExtra);
                                break;
                            case 3: // Proper Fixed Shrooms
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/shroom", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/shroomGlow", (AssetRequestMode)2).Value;
                                textToSend = "Toggle Full Shrooms";
                                textToSendFormat = "[c/ffcc44:Toggles a custom odd mushroom effect that perfectly copies]\n[c/ffcc44:almost everything]";
                                thingToSend = ref Toggles.ProperShrooms;
                                toggleOnClickExtra = TogglesUIManager.SpecialToggleOnClick.None;
                                TogglesUIManager.DrawElementWithBasicToggle(spriteBatch, baseTexture, glowTexture, player, i, baseVerticalOffset, baseVerticalInterval, textToSend, textToSendFormat, ref thingToSend, toggleOnClickExtra);
                                break;
                            case 4: // Proper Shrooms Shader effect.
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/shroom", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/shroomGlow", (AssetRequestMode)2).Value;
                                textToSend = "Toggle Full Shrooms RGB";
                                textToSendFormat = "[c/ffcc44:Toggles making proper shrooms have the RGB shader effect]";
                                thingToSend = ref Toggles.ShroomShader;
                                toggleOnClickExtra = TogglesUIManager.SpecialToggleOnClick.None;
                                TogglesUIManager.DrawElementWithBasicToggle(spriteBatch, baseTexture, glowTexture, player, i, baseVerticalOffset, baseVerticalInterval, textToSend, textToSendFormat, ref thingToSend, toggleOnClickExtra);
                                break;
                        }
                    ...
                    #region Light Hack
                    Texture2D autoTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/lightHack", (AssetRequestMode)2).Value;
                    Texture2D statusTexture = Toggles.LightHack > 0 ? ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/Tick", (AssetRequestMode)2).Value : ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/Cross", (AssetRequestMode)2).Value;
                    Texture2D statusTextureGlow = Toggles.LightHack > 0 ? ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/TickGlow", (AssetRequestMode)2).Value : ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/CrossGlow", (AssetRequestMode)2).Value;
                    ...
                    if (isHovering)
                    {
                        ...
                        {
                            Texture2D hoverTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/lightHackGlow", (AssetRequestMode)2).Value;
                ...
                case 2:
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        switch (i)
                        {
                            case 0: // Draedon Weapons Charge
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/charge", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/chargeGlow", (AssetRequestMode)2).Value;
                            ...
                            case 1: // MNL Indicator.
                                ...
                                break;
                            case 2: // Sass Mode.
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/sass", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/Powers/sassGlow", (AssetRequestMode)2).Value;
                                ...
                                break;
                            case 3: // DPS
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/dps", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/dpsGlow", (AssetRequestMode)2).Value;
                                ...
                                break;
                            case 4: // Tester Times
                                baseTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/tester", (AssetRequestMode)2).Value;
                                glowTexture = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/Textures/testerGlow", (AssetRequestMode)2).Value;
