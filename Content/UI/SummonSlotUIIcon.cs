...
namespace CalNohitQoL.Content.UI
{
    public class SummonSlotUIIcon
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            Texture2D Icon = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/summonUI", (AssetRequestMode)2).Value;
            Texture2D HoverIcon = ModContent.Request<Texture2D>("CalNohitQoL/Content/UI/summonUIHover", (AssetRequestMode)2).Value;
