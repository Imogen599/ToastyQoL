...
{
    public class BetsySpawner : ModItem
    {
        public int Amount = 1;
        public Color TextColor = new Color(153, 0, 0);
        public string bossname = "Betsy";
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            else
            {
                ...
                {
                    int idx = NPC.NewNPC(null, (int)player.Center.X - 600, (int)player.Center.Y, NPCID.DD2Betsy, 1);
                }
        ...
        {
            Color color = CalNohitQoLUtils.TwoColorPulse(Color.IndianRed, Color.DarkOrchid, 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CalamityMod.Items.Materials.ScoriaBar>(), 5);
